        ...
        routes: [
          {
            ...
            routes: [
              {
                path: '/docs/api',
                component: ComponentCreator('/docs/api', '413'),
                exact: true,
              ...
              {
                path: '/docs/models/photosynthesis',
                component: ComponentCreator('/docs/models/photosynthesis', '732'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/models/stomatal-conductance',
                component: ComponentCreator('/docs/models/stomatal-conductance', 'c2e'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/notebooks/photosynthesis-analysis',
                component: ComponentCreator('/docs/notebooks/photosynthesis-analysis', '93c'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/notebooks/stomatal-conductance-analysis',
                component: ComponentCreator('/docs/notebooks/stomatal-conductance-analysis', '9d9'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
